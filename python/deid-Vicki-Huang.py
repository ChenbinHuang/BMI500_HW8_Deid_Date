...
# Identify Date Year only; does not identify expressions with full month/day/year
dateyear_pattern = '(19\d\d | 20[0-2]\d )|( \'\d\d)|(\d\d\'\.)|(\ 00 |\ 00\.)'

# Compile regex expression
dateyear_reg = re.compile(dateyear_pattern)


def check_for_dateyear(patient,note,chunk, output_handle):
    """
    Inputs:
        ...
        - output_handle: an opened file handle. The results will be written to this file.
            ...
            to this function. 
    Logic:
        Search the entire chunk for date year occurrences. Find the location of these occurrences 
        ...
        Use the precompiled regular expression to find all years.
        The regular expression used will identify all 4 character years in the range 1900-2029 as well as
        2 character years with either a leading or trailing apostrophe (') (e.g. '82 or 82'). 
    """
    ...
    for match in dateyear_reg.finditer(chunk):
...
def deid_dateyear(text_path= 'id.text', output_path = 'dateyear.phi'):
    """
    Inputs: 
        ...
        with open(text_path) as text:
            ...
            for line in text:
                ...
                if len(record_end):
                    ...
                    check_for_dateyear(patient,note,chunk.strip(), output_file)
...
if __name__== "__main__":
    ...
    deid_dateyear(sys.argv[1], sys.argv[2])
