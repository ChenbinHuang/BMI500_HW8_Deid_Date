...
def run_stats(gold_path = 'id.deid', gold_cats_path= 'id-phi.phrase', test_path='phone.phi'):
    ...
    """
    stats = open('stats-Vicki-Huang.txt','w')
    ...
    stats.write('Total events in \'{}\': {}'.format(gold_cats_path,total_events_gold_cats))
    ...
    for current_cat in categories:
        ...
        stats.write("Examining \"{}\" category.".format(current_cat))
